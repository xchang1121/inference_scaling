...
def test_ar_smoke_profile_exercises_each_sweep_with_bounded_lengths(
    ...
    assert {
        ...
        "default-block_conditional_is-reward-verifier",
        "default-block_conditional_is-reward-sequence_log_probability",
        "default-block_conditional_is-reward-consilience",
