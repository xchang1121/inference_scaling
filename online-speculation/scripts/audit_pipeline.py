...
from blockspec.checkpoint import (adapter_fingerprint, base_fingerprint,
...
def reference_decoder(revision, root):
    ...
    module = types.ModuleType("blockspec._migration_reference")
    module.__package__ = "blockspec"
