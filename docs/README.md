...
1. [GSM8K 方法质量与计算量实验](reports/GSM8K_3090_ALIGNED_RESULTS.md)：最小必要设置、准确率、
   pass@k、质量消融与结果解读。
...
| [RTX 3090 推理基础设施优化汇总](reports/RTX3090_ROLLOUT_INFRA.md) | 成对墙钟/FLOPs、复用与冷启动结果及其适用范围 |
...
| 文档 | 用途 |
| --- | --- |
| [推理算法实现](methods/ALGORITHMS.md) | 所有算法的统一入口；含论文来源、数学细节、关键代码、精确性与近似来源 |
| [推理基础设施实现](methods/INFRASTRUCTURE.md) | 所有 infra 机制的统一入口；含论文来源、收益机制、额外成本、后端与计量 |
